...
plt.legend((p0[0],p1[0], p2[0]), ('500-1000mW-one EHnode', '750-1000 mW-one EHnode','500-750 mW-one EHnode'), fontsize=18)
plt.grid()
plt.show()
l1=[]
for i in range(1,16):
	l1.append(g1_link_level_schedule_length[i]-g2_link_level_schedule_length[i])
